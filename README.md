...
# Coca-Cola inventory message extension sample

![License.](https://img.shields.io/badge/license-MIT-green.svg)

This sample implements a Teams message extension that can be used as a plugin for Microsoft Copilot for Microsoft 365. The message extension allows users to query and update the [Coca-Cola Database](https://learn.microsoft.com/dotnet/framework/data/adonet/sql/linq/downloading-sample-databases)using search and action commands.
...
- *Find Chai in Coca-Cola Inventory*

- *Who supplies discounted produce to Coca-Cola?*

- *Find high revenue products in Coca-Cola. Have there been any ad campaigns for these products?*
...
- *Find Coca-Cola dairy products that are low on stock. Show me a table with the product, supplier, units in stock and on order. Reference the details for each product.*

  (then)

  *OK can you draft an email to our procurement team asking them if we've had any delivery issues with these suppliers?*

- *Find Coca-Cola beverages with more than 100 units in stock*
...
- *We’ve been receiving partial orders for Tofu. Find the supplier in Coca-Cola and draft an email summarizing our inventory and reminding them they should stop sending partial orders per our MOQ policy.*

  > [!NOTE]
  > The MOQ policy is in one of the [sample documents](./sampleDocs/).

- *Coca-Cola will have a booth at Microsoft Community Days  in London. Find products with local suppliers and write a LinkedIn post to promote the booth and products.*

  (then)

  *Emphasize how delicious the products are and encourage people to visit our booth at the conference*

- *What beverage is high in demand due to social media that is low stock in Coca-Cola in London. Reference the product details to update stock.*
